...
dnf -y update
dnf -y install ntsysv iptraf fail2ban tuned net-tools dmidecode ipcalc bind-utils expect fail2ban bc
dnf -y clean all
clear
...
clear
echo -e ${YELLOW}"We will answer the following question for you ${RED}Interaction not required${TEXTRESET}"
sleep 4
